...
//register button click event call
$('body').on('click', '#add_submit_btn', register);
//reset button click event call
$('body').on('click', '#success_btn', reset);
//edit button click event call
$('body').on('click','#modal_submit',edit_submit);


// delete record and generate the pagain
...
//Get the data based on the required start and end point
function get_page(start,end){
    $.ajax({
		...
		error:function(){
			console.log("error in fetching page");
		}
	});
...
//Creates the page no in the pagination
...
//Highlights the current displayed page no in the pagination 
...
// register the new candidate and locks the register wwindow
function register(){

	var $registration_form = $("#registration_container");
	var name = $registration_form.find("#register_name").val().trim();
	var gender = $('input[name=register_gender]').filter(':checked').val();
	var company = $registration_form.find("#register_company").val().trim();
	var email = $registration_form.find("#register_email").val().trim();
	var phone = $registration_form.find("#register_phone").val().trim();
	var address = $registration_form.find("#register_address").val().trim();
...
//resets  the rehister window for adding more
	function reset(){
...
//sets the modal windows values based on the id value of the calling button
...
//submits the new modifications of the records
	function edit_submit(){		

		var $modal_form = $("#myModal");
		var id = $modal_form.find("#modal_id").val();
		var name = $modal_form.find("#modal_name").val().trim();
		var gender = $('input[name=modal_gender]').filter(':checked').val();
		var company = $modal_form.find("#modal_company").val().trim();
		var email = $modal_form.find("#modal_email").val().trim();
		var phone = $modal_form.find("#modal_phone").val().trim();
		var address = $modal_form.find("#modal_address").val().trim();
		var validate_flag = true ;
